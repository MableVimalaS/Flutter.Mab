...
import '../../../../core/help/coach_mark_service.dart';
...
class TimeWalletPage extends StatefulWidget {
  const TimeWalletPage({super.key});

  @override
  State<TimeWalletPage> createState() => _TimeWalletPageState();
}

class _TimeWalletPageState extends State<TimeWalletPage> {
  final _countdownRingKey = GlobalKey();
  final _lifeClockKey = GlobalKey();
  ...
  void _maybeShowCoachMarks() {
    ...
    if (!storage.hasShownCoachMarks && storage.hasCompletedOnboarding) {
      CoachMarkService.showWalletTour(
        context: context,
        storage: storage,
        countdownRingKey: _countdownRingKey,
        lifeClockKey: _lifeClockKey,
        fabKey: _fabKey,
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            const InfoTooltip(
                              message:
                                  'Your streak counts consecutive days with at least one activity logged.',
                            ),
                          ],
                        ),
                      ),
                ...
                SliverPadding(
                  ...
                  sliver: SliverList.list(
                    children: [
                      ...
                      // Nav bar key target (invisible, placed at bottom)
                      SizedBox(
                        key: _navBarKey,
                        height: 100,
                      ),
